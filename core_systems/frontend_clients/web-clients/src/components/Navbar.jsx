      ...
      <div className="px-3 sm:px-4 md:px-6 py-2.5 sm:py-3 md:py-4">
        <div className="flex items-center justify-between gap-2 sm:gap-3">
          ...
          <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-shrink">
            <button onClick={onMenuClick} className="p-1.5 sm:p-2 rounded-lg sm:rounded-xl bg-white/5 hover:bg-white/10 text-purple-200 hover:text-white transition-all duration-300">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3 flex-shrink-0">
            ...
            {/* Cameras Button */}
            <Link to="/cameras">
              <button className="relative p-1.5 sm:p-2 rounded-lg sm:rounded-xl bg-white/5 hover:bg-white/10 text-purple-200 hover:text-white transition-all duration-300 group">
                <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                </svg>
                <span className="absolute -top-1 -right-1 w-4 h-4 sm:w-5 sm:h-5 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center text-[8px] sm:text-[10px] font-bold animate-pulse">
                  30
                </span>
              </button>
            </Link>
